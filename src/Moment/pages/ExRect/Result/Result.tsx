...
const Result: FC<Props> = ({ result }) => {
	...
	return (
		<>
			...
			<ForcesInBolts res={result.calc.forcesInBolts} formulas={result.formulas?.forcesInBolts} />
			<BoltStrength res={result.calc.bolt} formulas={result.formulas?.bolt} gasket={result.gasket} />
			<Conclusions res={result.calc.bolt} gasket={result.gasket} />
			<Moment res={result.calc.moment} formulas={result.formulas?.moment} gasket={result.gasket} />
		</>
	)
}
