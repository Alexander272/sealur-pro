...
import { IStaticResistance, IStaticResistanceFormulas } from '../../../../../types/res_flange'
...
export const StaticResistanceData: FC<Props> = ({ data, flange, title, formulas }) => {
	return (
		<>
			...
			<p className={classes.text}>Расчетный изгибающий момент действующий на фланец при затяжке</p>
			<ResLine
			...
			<p className={classes.text}>Расчетный изгибающий момент действующий на фланец в рабочих условиях</p>
			<ResLine
				title='- для приварного встык фланца плоского и бурта свободного фланца'
			...
			<p className={classes.text}>
				Меридиональное изгибное напряжение во втулке приварного встык фланца обечайке трубе плоского фланца или
				обечайке бурта свободного фланца
			</p>
			{!data.isEqualSigma ? (
				<>
					<ResLine
			...
			<p className={classes.text}>
				Меридиональные изгибные напряжения во втулке приварного встык фланца обечайке трубе плоского фланца или
				обечайке трубе бурта свободного фланца в рабочих условиях
			</p>
			{!data.isEqualSigma ? (
				<>
					<ResLine
			...
			<p className={classes.text}>
				Меридиональные мембранные напряжения во втулке приварного встык фланца обечайке трубе плоского фланца
				или обечайке трубе бурта свободного фланца в рабочих условиях
			</p>
			{!data.isEqualSigma && (
				<ResLine
					title='- для приварных встык фланцев с конической втулкой в сечении S&#8321;'
			...
			<p className={classes.text}>
				Напряжения в тарелке приварного встык фланца плоского фланца и бурте свободного фланца в рабочих
				условиях
			</p>
			<ResLine
