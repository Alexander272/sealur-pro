	...
	return (
		<Container title={`Исходные данные для фланца`}>
			...
			{data.type === 'free' && data.ring ? (
				<>
					<Line
						...
						res={formatNumber(data.ring.dnk)}
						units='мм'
					/>
					<Line
			...
			<Line
				...
				units='мм'
			/>
			<Line title='Прибавка на коррозию' designation={<i>c</i>} res={formatNumber(data.c)} units='мм' />
			...
			{data.type === 'free' && data.ring ? (
				<>
					<Line
						...
						res={formatNumber(data.ring.alpha)}
						units='1/&#8451;'
					/>
					<Line
						...
						res={formatNumber(data.ring.epsilonAt20)}
						units='МПа'
					/>
					<Line
						...
						res={formatNumber(data.ring.epsilon)}
						units='МПа'
					/>
					<Line
						...
						res={formatNumber(data.ring.sigmaAt20)}
						units='МПа'
					/>
					<Line
						...
						res={formatNumber(data.ring.sigma)}
						units='МПа'
					/>
				</>
			) : null}
