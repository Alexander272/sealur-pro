...
export const List: FC<Props> = ({ materials, material, type, onClick }) => {
	...
	const saveHandler = async (data: IFullMaterial) => {
		try {
			...
			mutate(`/sealur-moment/materials/empty?type=${type}`)
		} catch (error) {
	...
	return (
		<div className={classes.list}>
			...
			<Modal isOpen={isOpen} toggle={toggle}>
				<Modal.Header title={watchId === '' ? 'Добавить материал' : 'Редактировать материал'} />
				<Modal.Content>
					<Input label='Название' name='title' register={register} rule={{ required: true }} />
				</Modal.Content>
				<Modal.Footer>
