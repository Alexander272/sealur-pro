...
import { ICalcMoment, IGasketResult, IMomentFormulas } from "../../../../../types/res_exCircle"
import { formatNumber } from "../../../../../utils/format"
import classes from "../../../../styles/page.module.scss"

type Props = {
    res: ICalcMoment
    formulas: IMomentFormulas | undefined
    gasket: IGasketResult
}

export const Moment: FC<Props> = ({ res, formulas, gasket }) => {
    return res.Mkp && res.Mrek ? (
        <Container title='Расчет момента затяжки'>
            ...
            <p className={classes.text}>
                ...
                <b>
                    {gasket.type === "Soft" && res.Qmax > gasket.permissiblePres
