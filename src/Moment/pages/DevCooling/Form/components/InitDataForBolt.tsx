...
const boltTitles = {
	...
	// sigmaAt20: 'Номинальное допускаемое напряжение для болтов (шпилек) при температуре 20 ℃',
	// sigma: 'Номинальное допускаемое напряжение для болтов (шпилек) при расчетной температуре',
}
