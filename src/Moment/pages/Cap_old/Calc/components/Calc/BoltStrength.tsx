...
export const BoltStrength: FC<Props> = ({ data, res, formulas, path, sigmaB1, sigmaB2, dSigmaM, dSigmaR, q }) => {
	return (
			...
			<ConditionLine
				...
				result={
					<>
						...
						{data[path as 'basis'][sigmaB1 as 'sigmaB1'] <= data[path as 'basis'][dSigmaM as 'sigmaB1'] ? (
							<> &le; </>
						) : (
							' > '
						)}
			...
			<ConditionLine
				...
				result={
					<>
						...
						{data[path as 'basis'][sigmaB2 as 'sigmaB1'] <= data[path as 'basis'][dSigmaR as 'sigmaB1'] ? (
							<> &le; </>
						) : (
							' > '
						)}
					...
					<ConditionLine
						...
						result={
							<>
								...
								{data[path as 'basis'][q as 'sigmaB1'] <= res.permissiblePres ? <> &le; </> : ' > '}
								&nbsp;
