...
import { ICalculateCap } from '../../../../../types/res_cap_old'
	...
	return (
		<Container title='Выводы о прочности фланцевого соединения'>
			<p className={classes.text}>
				...
				<b>{data[pathBasis as 'basis']['vSigmaB1'] ? 'выдерживает нагрузки' : 'не выдерживает нагрузки'}</b>
			</p>
			<p className={classes.text}>
				- при рабочей температуре {formatNumber(temp)} &#8451;, т.е. в условиях эксплуатации, фланцевое
				соединение{' '}
				<b>{data[pathBasis as 'basis']['vSigmaB2'] ? 'выдерживает нагрузки' : 'не выдерживает нагрузки'}</b>
			</p>
			{gasket.type === 'Мягкая' && (
				<p className={classes.text}>
